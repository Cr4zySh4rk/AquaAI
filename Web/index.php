...
<html lang="en">
  ...
  <body>
    <script>
      let soilFilename = '/home/pi/data.csv';
...
function updatePhosphorusChart(loadedData) {
    ...
    function updateWaterDispensedChart(loadedData) {
      ...
      loadDataAndUpdateCharts('/home/pi/data.csv', updateSoilChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updateTemperatureChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updateHumidityChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updateNitrogenChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updatePhosphorusChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updatePotassiumChart);
      loadDataAndUpdateCharts('/home/pi/data.csv', updateWaterDispensedChart);
  </script>
    ...
    <div class="mainwrap">
      ...
      <div class="wrapper">
        <div class="metrics">
          ...
          <div class="metric-container">
            <h1>Current Soil Moisture : </br> <?php $moisture=shell_exec("awk -F ',' '{last_value = $3} END {print last_value}' /home/pi/data.csv"); echo($moisture);?>%</h1>
          </div>
          <div class="metric-container">
            <h1>Total Water Dispensed : </br> <?php $water=shell_exec("awk -F ',' '{Total=Total+$7} END{print Total}' /home/pi/data.csv"); echo($water);?> mL</h1>
          </div>
        </div>
