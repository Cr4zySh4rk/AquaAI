...
function updatePhosphorusChart(loadedData) {
    ...
    function updateWaterDispensedChart(loadedData) {
      ...
      loadDataAndUpdateCharts('data.csv', updateSoilChart);
      loadDataAndUpdateCharts('data.csv', updateTemperatureChart);
      loadDataAndUpdateCharts('data.csv', updateHumidityChart);
      loadDataAndUpdateCharts('data.csv', updateNitrogenChart);
      loadDataAndUpdateCharts('data.csv', updatePhosphorusChart);
      loadDataAndUpdateCharts('data.csv', updatePotassiumChart);
      loadDataAndUpdateCharts('data.csv', updateWaterDispensedChart);
  </script>
